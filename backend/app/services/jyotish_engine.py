...
class JyotishEngine:
    ...
    def get_complete_panchanga(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'star_lord': star_lord,
            'star_lord_tamil': PLANET_TAMIL.get(star_lord, star_lord),
            'ganam': ganam,
            'ganam_tamil': {'Deva': 'தேவ', 'Manushya': 'மனுஷ்ய', 'Rakshasa': 'ராக்ஷச'}.get(ganam, ganam),
            'yoni': yoni,
            'yoni_tamil': nakshatra_data.get('yoni_tamil', yoni),
            'bird': bird,
            'tree': tree,
            'moon_rasi': moon_rasi,
            'moon_rasi_tamil': RASI_TAMIL[moon_rasi_idx],
            'moon_rasi_lord': moon_rasi_lord,
            'moon_rasi_lord_tamil': PLANET_TAMIL.get(moon_rasi_lord, moon_rasi_lord),
            'lagna': lagna,
            'lagna_tamil': RASI_TAMIL[lagna_idx],
            'lagna_lord': lagna_lord,
            'lagna_lord_tamil': PLANET_TAMIL.get(lagna_lord, lagna_lord),
            'lagna_degree': self.lagna_degree,
            'lagna_degree_dms': self._deg_to_dms(self.lagna_degree),
            'ayanamsa': f"Chitra Paksha = {ayanamsa_deg} Deg. {ayanamsa_min} Min. {ayanamsa_sec} Sec.",
            'ayanamsa_value': f"Lahiri {ayanamsa_deg + ayanamsa_min/60 + ayanamsa_sec/3600:.4f}°",
            'sunrise': sunrise,
            'sunset': sunset,
            ...
            'dagda_rasi_tamil': ', '.join([RASI_TAMIL[RASIS.index(r)] if r in RASIS else r for r in dagda_rasi.split(', ')]) if dagda_rasi else '',
            'yogi_point': yogi_point_dms,
            'yogi_nakshatra': yogi_nakshatra,
            'yogi_planet': yogi_planet,
            'yogi_planet_tamil': PLANET_TAMIL.get(yogi_planet, yogi_planet),
            'duplicate_yogi': duplicate_yogi,
            'duplicate_yogi_tamil': PLANET_TAMIL.get(duplicate_yogi, duplicate_yogi) if duplicate_yogi else '',
            'avayogi_star': avayogi_star,
            'avayogi_planet': avayogi_planet,
            'avayogi_planet_tamil': PLANET_TAMIL.get(avayogi_planet, avayogi_planet),
            'atma_karaka': atma_karaka,
            'atma_karaka_tamil': PLANET_TAMIL.get(atma_karaka, atma_karaka),
            'amatya_karaka': amatya_karaka,
            'amatya_karaka_tamil': PLANET_TAMIL.get(amatya_karaka, amatya_karaka),
            'lagna_pada': lagna_pada_sign,
            'lagna_pada_tamil': RASI_TAMIL[RASIS.index(lagna_pada_sign)] if lagna_pada_sign in RASIS else lagna_pada_sign,
            'dhana_pada': dhana_pada_sign,
            'dhana_pada_tamil': RASI_TAMIL[RASIS.index(dhana_pada_sign)] if dhana_pada_sign in RASIS else dhana_pada_sign,
            ...
            'dasa_system_tamil': 'விம்ஷோத்தரி, வருடங்கள் = 365.25 நாட்கள்'
        }
