...
export const TAMIL_NADU_CITIES = [
  ...
  // More Tamil Nadu Towns
  { name: 'திருவட்டாரு', nameEn: 'Thiruvattaru', lat: 8.3167, lng: 77.2667, state: 'Tamil Nadu' },
  { name: 'குளச்சல்', nameEn: 'Kulasekarapattinam', lat: 8.3833, lng: 78.0833, state: 'Tamil Nadu' },
  { name: 'வள்ளியூர்', nameEn: 'Valliyoor', lat: 8.3833, lng: 77.6167, state: 'Tamil Nadu' },
  { name: 'அம்பாசமுத்திரம்', nameEn: 'Ambasamudram', lat: 8.7167, lng: 77.4500, state: 'Tamil Nadu' },
  { name: 'ஆலங்குளம்', nameEn: 'Alangulam', lat: 8.8631, lng: 77.4969, state: 'Tamil Nadu' },
  { name: 'ஆத்தூர்', nameEn: 'Attur', lat: 11.5970, lng: 78.6017, state: 'Tamil Nadu' },
  { name: 'மேட்டூர்', nameEn: 'Mettur', lat: 11.7875, lng: 77.8014, state: 'Tamil Nadu' },
  { name: 'ஓமலூர்', nameEn: 'Omalur', lat: 11.7449, lng: 78.0454, state: 'Tamil Nadu' },
  { name: 'சங்ககிரி', nameEn: 'Sankagiri', lat: 11.4692, lng: 77.8656, state: 'Tamil Nadu' },
  { name: 'ராசிபுரம்', nameEn: 'Rasipuram', lat: 11.4652, lng: 78.1831, state: 'Tamil Nadu' },
  { name: 'திருச்செங்கோடு', nameEn: 'Tiruchengode', lat: 11.3833, lng: 77.8833, state: 'Tamil Nadu' },
  { name: 'பவானி', nameEn: 'Bhavani', lat: 11.4505, lng: 77.6833, state: 'Tamil Nadu' },
  { name: 'சத்தியமங்கலம்', nameEn: 'Sathyamangalam', lat: 11.5073, lng: 77.2386, state: 'Tamil Nadu' },
  { name: 'கோபிச்செட்டிபாளையம்', nameEn: 'Gobichettipalayam', lat: 11.4558, lng: 77.4419, state: 'Tamil Nadu' },
  { name: 'அந்தியூர்', nameEn: 'Anthiyur', lat: 11.5728, lng: 77.5883, state: 'Tamil Nadu' },
  { name: 'மேட்டுப்பாளையம்', nameEn: 'Mettupalayam', lat: 11.2997, lng: 76.9400, state: 'Tamil Nadu' },
  { name: 'ஆவினாசி', nameEn: 'Avinashi', lat: 11.1921, lng: 77.2683, state: 'Tamil Nadu' },
  { name: 'பல்லடம்', nameEn: 'Palladam', lat: 10.9922, lng: 77.2869, state: 'Tamil Nadu' },
  { name: 'உடுமலைப்பேட்டை', nameEn: 'Udumalaipettai', lat: 10.5869, lng: 77.2489, state: 'Tamil Nadu' },
  { name: 'பழனி', nameEn: 'Palani', lat: 10.4505, lng: 77.5164, state: 'Tamil Nadu' },
  { name: 'ஒட்டன்சத்திரம்', nameEn: 'Ottanchatram', lat: 10.4000, lng: 77.7667, state: 'Tamil Nadu' },
  { name: 'நத்தம்', nameEn: 'Natham', lat: 10.2231, lng: 78.1872, state: 'Tamil Nadu' },
  { name: 'வேடசந்தூர்', nameEn: 'Vedasandur', lat: 10.5167, lng: 77.9500, state: 'Tamil Nadu' },
  { name: 'போடிநாயக்கனூர்', nameEn: 'Bodinayakanur', lat: 10.0100, lng: 77.3500, state: 'Tamil Nadu' },
  { name: 'கம்பம்', nameEn: 'Cumbum', lat: 9.7333, lng: 77.2833, state: 'Tamil Nadu' },
  { name: 'உத்தமபாளையம்', nameEn: 'Uthamapalayam', lat: 9.8033, lng: 77.3333, state: 'Tamil Nadu' },
  { name: 'ஆண்டிபட்டி', nameEn: 'Andipatti', lat: 9.9833, lng: 77.6167, state: 'Tamil Nadu' },
  { name: 'பெரியகுளம்', nameEn: 'Periyakulam', lat: 10.1167, lng: 77.5500, state: 'Tamil Nadu' },
  { name: 'மேலூர்', nameEn: 'Melur', lat: 10.0333, lng: 78.3333, state: 'Tamil Nadu' },
  { name: 'திருமங்கலம்', nameEn: 'Thirumangalam', lat: 9.8167, lng: 77.9833, state: 'Tamil Nadu' },
  { name: 'உசிலம்பட்டி', nameEn: 'Usilampatti', lat: 9.9667, lng: 77.7833, state: 'Tamil Nadu' },
  { name: 'வாதிராயிருப்பு', nameEn: 'Vadipatti', lat: 10.0833, lng: 77.9667, state: 'Tamil Nadu' },
  { name: 'திருப்பரங்குன்றம்', nameEn: 'Thiruparankundram', lat: 9.8833, lng: 78.0667, state: 'Tamil Nadu' },
  { name: 'அரவக்குறிச்சி', nameEn: 'Aravakurichi', lat: 10.9500, lng: 78.0833, state: 'Tamil Nadu' },
  { name: 'குளித்தலை', nameEn: 'Kulithalai', lat: 10.9333, lng: 78.4167, state: 'Tamil Nadu' },
  { name: 'மனப்பாறை', nameEn: 'Manapparai', lat: 10.6167, lng: 78.4167, state: 'Tamil Nadu' },
  { name: 'முசிறி', nameEn: 'Musiri', lat: 10.9500, lng: 78.4333, state: 'Tamil Nadu' },
  { name: 'தொட்டியம்', nameEn: 'Thottiyam', lat: 10.9833, lng: 78.3333, state: 'Tamil Nadu' },
  { name: 'லால்குடி', nameEn: 'Lalgudi', lat: 10.8833, lng: 78.8167, state: 'Tamil Nadu' },
  { name: 'புள்ளம்பாடி', nameEn: 'Pullambadi', lat: 10.9667, lng: 78.8500, state: 'Tamil Nadu' },
  { name: 'திருவெறும்பூர்', nameEn: 'Thiruverumbur', lat: 10.7833, lng: 78.7667, state: 'Tamil Nadu' },
  { name: 'ஜெயங்கொண்டம்', nameEn: 'Jayamkondam', lat: 11.2167, lng: 79.3667, state: 'Tamil Nadu' },
  { name: 'உடையார்பாளையம்', nameEn: 'Udayarpalayam', lat: 11.2000, lng: 79.3167, state: 'Tamil Nadu' },
  { name: 'மண்ணார்குடி', nameEn: 'Mannargudi', lat: 10.6667, lng: 79.4500, state: 'Tamil Nadu' },
  { name: 'திருத்துறைப்பூண்டி', nameEn: 'Thiruthuraipoondi', lat: 10.5333, lng: 79.6333, state: 'Tamil Nadu' },
  { name: 'வேதாரண்யம்', nameEn: 'Vedaranyam', lat: 10.3833, lng: 79.8500, state: 'Tamil Nadu' },
  { name: 'சீர்காழி', nameEn: 'Sirkali', lat: 11.2333, lng: 79.7333, state: 'Tamil Nadu' },
  { name: 'திருநாலாரு', nameEn: 'Thirunallar', lat: 10.8833, lng: 79.8500, state: 'Tamil Nadu' },
  { name: 'பூம்புகார்', nameEn: 'Poompuhar', lat: 11.1500, lng: 79.8500, state: 'Tamil Nadu' },
  { name: 'பட்டுக்கோட்டை', nameEn: 'Pattukottai', lat: 10.4333, lng: 79.3167, state: 'Tamil Nadu' },
  { name: 'அறந்தாங்கி', nameEn: 'Aranthangi', lat: 10.1667, lng: 78.9833, state: 'Tamil Nadu' },
  { name: 'ஆவுடையார்கோவில்', nameEn: 'Avudaiyarkoil', lat: 10.0167, lng: 79.0167, state: 'Tamil Nadu' },
  { name: 'இலுப்பூர்', nameEn: 'Iluppoor', lat: 10.1000, lng: 78.6167, state: 'Tamil Nadu' },
  { name: 'கீரனூர்', nameEn: 'Keeranur', lat: 10.3667, lng: 78.8167, state: 'Tamil Nadu' },
  { name: 'கருப்பூர்', nameEn: 'Karuppoor', lat: 9.7167, lng: 78.7667, state: 'Tamil Nadu' },
  { name: 'திருப்பத்தூர்', nameEn: 'Thiruppathur', lat: 9.4333, lng: 78.3833, state: 'Tamil Nadu' },
  { name: 'கமுதி', nameEn: 'Kamuthi', lat: 9.4000, lng: 78.9500, state: 'Tamil Nadu' },
  { name: 'முதுகுளத்தூர்', nameEn: 'Mudukulathur', lat: 9.3333, lng: 78.5167, state: 'Tamil Nadu' },
  { name: 'சாயல்குடி', nameEn: 'Sayalgudi', lat: 9.1667, lng: 78.4333, state: 'Tamil Nadu' },
  { name: 'மண்டபம்', nameEn: 'Mandapam', lat: 9.2667, lng: 79.1167, state: 'Tamil Nadu' },
  { name: 'இராமேஸ்வரம்', nameEn: 'Rameswaram', lat: 9.2876, lng: 79.3129, state: 'Tamil Nadu' },
  { name: 'தனுஷ்கோடி', nameEn: 'Dhanushkodi', lat: 9.1667, lng: 79.4167, state: 'Tamil Nadu' },
  { name: 'திருவேற்காடு', nameEn: 'Thiruvallur', lat: 13.1231, lng: 79.9067, state: 'Tamil Nadu' },
  { name: 'திருவள்ளூர்', nameEn: 'Tiruvallur', lat: 13.1431, lng: 79.9120, state: 'Tamil Nadu' },
  { name: 'பொன்னேரி', nameEn: 'Ponneri', lat: 13.3333, lng: 80.2000, state: 'Tamil Nadu' },
  { name: 'உத்திரமேரூர்', nameEn: 'Uthiramerur', lat: 12.6167, lng: 79.7500, state: 'Tamil Nadu' },
  { name: 'செய்யூர்', nameEn: 'Seyyur', lat: 12.3500, lng: 79.9833, state: 'Tamil Nadu' },
  { name: 'மாரக்காணம்', nameEn: 'Marakkanam', lat: 12.2000, lng: 79.9500, state: 'Tamil Nadu' },
  { name: 'திண்டிவனம்', nameEn: 'Tindivanam', lat: 12.2333, lng: 79.6500, state: 'Tamil Nadu' },
  { name: 'கீழ்ப்பென்னாத்தூர்', nameEn: 'Keezhpennathur', lat: 12.1000, lng: 79.5167, state: 'Tamil Nadu' },
  { name: 'சன்னாநல்லூர்', nameEn: 'Sannanallur', lat: 11.8667, lng: 79.3500, state: 'Tamil Nadu' },
  { name: 'ஜெனி', nameEn: 'Gingee', lat: 12.2500, lng: 79.4167, state: 'Tamil Nadu' },
  { name: 'கள்ளக்குறிச்சி', nameEn: 'Kallakurichi', lat: 11.7333, lng: 78.9500, state: 'Tamil Nadu' },
  { name: 'உளுந்தூர்பேட்டை', nameEn: 'Ulundurpettai', lat: 11.7500, lng: 79.3167, state: 'Tamil Nadu' },
  { name: 'திட்டக்குடி', nameEn: 'Thittakudi', lat: 11.5167, lng: 79.3833, state: 'Tamil Nadu' },
  { name: 'வடலூர்', nameEn: 'Vadalur', lat: 11.5500, lng: 79.4667, state: 'Tamil Nadu' },
  { name: 'நெய்வேலி', nameEn: 'Neyveli', lat: 11.6000, lng: 79.5000, state: 'Tamil Nadu' },
  { name: 'பண்ருட்டி', nameEn: 'Panruti', lat: 11.7667, lng: 79.5500, state: 'Tamil Nadu' },
  { name: 'காட்டுமன்னார்கோயில்', nameEn: 'Kattumannarkoil', lat: 11.4000, lng: 79.5333, state: 'Tamil Nadu' },
  { name: 'வீராணம்', nameEn: 'Veeranam', lat: 11.4167, lng: 79.4833, state: 'Tamil Nadu' },
  { name: 'தொழுதூர்', nameEn: 'Tozhuthur', lat: 11.6500, lng: 79.5000, state: 'Tamil Nadu' },
  { name: 'ஆற்காடு', nameEn: 'Arcot', lat: 12.9000, lng: 79.3333, state: 'Tamil Nadu' },
  { name: 'வாலாஜாபாத்', nameEn: 'Walajapet', lat: 12.9333, lng: 79.3667, state: 'Tamil Nadu' },
  { name: 'திருப்பத்தூர்', nameEn: 'Thirupattur', lat: 12.4955, lng: 78.5730, state: 'Tamil Nadu' },
  { name: 'வந்தவாசி', nameEn: 'Vandavasi', lat: 12.5000, lng: 79.6000, state: 'Tamil Nadu' },
  { name: 'செஞ்சி', nameEn: 'Chenji', lat: 12.2500, lng: 79.4167, state: 'Tamil Nadu' },
  { name: 'பொன்னை', nameEn: 'Pennai', lat: 11.7667, lng: 79.7833, state: 'Tamil Nadu' },
  { name: 'ஸ்ரீபெரும்புதூர்', nameEn: 'Sriperumbudur', lat: 12.9667, lng: 79.9333, state: 'Tamil Nadu' },
  { name: 'பாடி', nameEn: 'Padi', lat: 13.1000, lng: 80.2000, state: 'Tamil Nadu' },
  { name: 'அம்பத்தூர்', nameEn: 'Ambattur', lat: 13.1143, lng: 80.1548, state: 'Tamil Nadu' },
  { name: 'அவடி', nameEn: 'Avadi', lat: 13.1145, lng: 80.0970, state: 'Tamil Nadu' },
  { name: 'திருவொற்றியூர்', nameEn: 'Thiruvottiyur', lat: 13.1567, lng: 80.3000, state: 'Tamil Nadu' },
  { name: 'தாம்பரம்', nameEn: 'Tambaram', lat: 12.9249, lng: 80.1000, state: 'Tamil Nadu' },
  { name: 'குரோம்பேட்டை', nameEn: 'Chrompet', lat: 12.9517, lng: 80.1425, state: 'Tamil Nadu' },
  { name: 'பல்லாவரம்', nameEn: 'Pallavaram', lat: 12.9675, lng: 80.1491, state: 'Tamil Nadu' },
  { name: 'மேடவாக்கம்', nameEn: 'Medavakkam', lat: 12.9167, lng: 80.1833, state: 'Tamil Nadu' },
  { name: 'சோழிங்கநல்லூர்', nameEn: 'Sholinganallur', lat: 12.9000, lng: 80.2167, state: 'Tamil Nadu' },
  { name: 'கீழ்க்கட்டளை', nameEn: 'Keelkattalai', lat: 12.9667, lng: 80.2000, state: 'Tamil Nadu' },
  { name: 'வேளச்சேரி', nameEn: 'Velachery', lat: 12.9833, lng: 80.2167, state: 'Tamil Nadu' },
  { name: 'அடையாறு', nameEn: 'Adyar', lat: 13.0067, lng: 80.2567, state: 'Tamil Nadu' },
  { name: 'திருவான்மியூர்', nameEn: 'Thiruvanmiyur', lat: 12.9833, lng: 80.2667, state: 'Tamil Nadu' },
  { name: 'மைலாப்பூர்', nameEn: 'Mylapore', lat: 13.0337, lng: 80.2707, state: 'Tamil Nadu' },
  { name: 'அண்ணாநகர்', nameEn: 'Anna Nagar', lat: 13.0850, lng: 80.2101, state: 'Tamil Nadu' },
  { name: 'நுங்கம்பாக்கம்', nameEn: 'Nungambakkam', lat: 13.0569, lng: 80.2425, state: 'Tamil Nadu' },
  { name: 'தி.நகர்', nameEn: 'T. Nagar', lat: 13.0418, lng: 80.2341, state: 'Tamil Nadu' },
  { name: 'ஈகட்டுத்தாங்கல்', nameEn: 'Egatoor', lat: 12.8500, lng: 80.2167, state: 'Tamil Nadu' },
  { name: 'மகாபலிபுரம்', nameEn: 'Mahabalipuram', lat: 12.6172, lng: 80.1927, state: 'Tamil Nadu' },
  { name: 'கோவளம்', nameEn: 'Kovalam', lat: 12.4333, lng: 80.0333, state: 'Tamil Nadu' },
  { name: 'புதுச்சேரி', nameEn: 'Puducherry', lat: 11.9416, lng: 79.8083, state: 'Puducherry' },
];
...
export const KERALA_CITIES = [
  ...
  // More Kerala Towns
  { name: 'Attingal', nameEn: 'Attingal', lat: 8.6964, lng: 76.8142, state: 'Kerala' },
  { name: 'Neyyattinkara', nameEn: 'Neyyattinkara', lat: 8.4000, lng: 77.0833, state: 'Kerala' },
  { name: 'Varkala', nameEn: 'Varkala', lat: 8.7333, lng: 76.7167, state: 'Kerala' },
  { name: 'Kayamkulam', nameEn: 'Kayamkulam', lat: 9.1667, lng: 76.5000, state: 'Kerala' },
  { name: 'Karunagappally', nameEn: 'Karunagappally', lat: 9.0500, lng: 76.5333, state: 'Kerala' },
  { name: 'Punalur', nameEn: 'Punalur', lat: 9.0167, lng: 76.9167, state: 'Kerala' },
  { name: 'Cherthala', nameEn: 'Cherthala', lat: 9.6833, lng: 76.3333, state: 'Kerala' },
  { name: 'Changanassery', nameEn: 'Changanassery', lat: 9.4500, lng: 76.5333, state: 'Kerala' },
  { name: 'Pala', nameEn: 'Pala', lat: 9.7167, lng: 76.6833, state: 'Kerala' },
  { name: 'Thodupuzha', nameEn: 'Thodupuzha', lat: 9.8833, lng: 76.7167, state: 'Kerala' },
  { name: 'Muvattupuzha', nameEn: 'Muvattupuzha', lat: 9.9833, lng: 76.5833, state: 'Kerala' },
  { name: 'Perumbavoor', nameEn: 'Perumbavoor', lat: 10.1167, lng: 76.4667, state: 'Kerala' },
  { name: 'Angamaly', nameEn: 'Angamaly', lat: 10.1833, lng: 76.3833, state: 'Kerala' },
  { name: 'Chalakudy', nameEn: 'Chalakudy', lat: 10.3000, lng: 76.3333, state: 'Kerala' },
  { name: 'Kodungallur', nameEn: 'Kodungallur', lat: 10.2167, lng: 76.2000, state: 'Kerala' },
  { name: 'Irinjalakuda', nameEn: 'Irinjalakuda', lat: 10.3500, lng: 76.2167, state: 'Kerala' },
  { name: 'Kunnamkulam', nameEn: 'Kunnamkulam', lat: 10.6500, lng: 76.0667, state: 'Kerala' },
  { name: 'Ottapalam', nameEn: 'Ottapalam', lat: 10.7667, lng: 76.3833, state: 'Kerala' },
  { name: 'Shoranur', nameEn: 'Shoranur', lat: 10.7667, lng: 76.2833, state: 'Kerala' },
  { name: 'Pattambi', nameEn: 'Pattambi', lat: 10.8000, lng: 76.1833, state: 'Kerala' },
  { name: 'Mannarkkad', nameEn: 'Mannarkkad', lat: 10.9833, lng: 76.4667, state: 'Kerala' },
  { name: 'Perinthalmanna', nameEn: 'Perinthalmanna', lat: 10.9667, lng: 76.2333, state: 'Kerala' },
  { name: 'Manjeri', nameEn: 'Manjeri', lat: 11.1167, lng: 76.1333, state: 'Kerala' },
  { name: 'Tirur', nameEn: 'Tirur', lat: 10.9167, lng: 75.9167, state: 'Kerala' },
  { name: 'Kottakkal', nameEn: 'Kottakkal', lat: 11.0000, lng: 75.9833, state: 'Kerala' },
  { name: 'Tanur', nameEn: 'Tanur', lat: 10.9667, lng: 75.8667, state: 'Kerala' },
  { name: 'Vadakara', nameEn: 'Vadakara', lat: 11.6000, lng: 75.5833, state: 'Kerala' },
  { name: 'Koyilandy', nameEn: 'Koyilandy', lat: 11.4500, lng: 75.6833, state: 'Kerala' },
  { name: 'Thalassery', nameEn: 'Thalassery', lat: 11.7500, lng: 75.4833, state: 'Kerala' },
  { name: 'Payyannur', nameEn: 'Payyannur', lat: 12.1000, lng: 75.2000, state: 'Kerala' },
  { name: 'Taliparamba', nameEn: 'Taliparamba', lat: 12.0333, lng: 75.3667, state: 'Kerala' },
  { name: 'Kanhangad', nameEn: 'Kanhangad', lat: 12.3000, lng: 75.1000, state: 'Kerala' },
  { name: 'Sultan Bathery', nameEn: 'Sultan Bathery', lat: 11.6667, lng: 76.2500, state: 'Kerala' },
  { name: 'Kalpetta', nameEn: 'Kalpetta', lat: 11.6097, lng: 76.0833, state: 'Kerala' },
  { name: 'Mananthavady', nameEn: 'Mananthavady', lat: 11.8000, lng: 76.0000, state: 'Kerala' },
  { name: 'Adoor', nameEn: 'Adoor', lat: 9.1500, lng: 76.7333, state: 'Kerala' },
  { name: 'Konni', nameEn: 'Konni', lat: 9.2333, lng: 76.8500, state: 'Kerala' },
  { name: 'Thiruvalla', nameEn: 'Thiruvalla', lat: 9.3833, lng: 76.5667, state: 'Kerala' },
  { name: 'Chengannur', nameEn: 'Chengannur', lat: 9.3167, lng: 76.6167, state: 'Kerala' },
];
...
export const KARNATAKA_CITIES = [
  ...
  // More Karnataka Towns
  { name: 'ಬಾಗಲಕೋಟೆ', nameEn: 'Bagalkot', lat: 16.1850, lng: 75.6960, state: 'Karnataka' },
  { name: 'ಗದಗ', nameEn: 'Gadag', lat: 15.4167, lng: 75.6333, state: 'Karnataka' },
  { name: 'ಹಾವೇರಿ', nameEn: 'Haveri', lat: 14.7942, lng: 75.4050, state: 'Karnataka' },
  { name: 'ಬೈನೂರು', nameEn: 'Byndoor', lat: 13.8667, lng: 74.6333, state: 'Karnataka' },
  { name: 'ಕುಂದಾಪುರ', nameEn: 'Kundapura', lat: 13.6204, lng: 74.6918, state: 'Karnataka' },
  { name: 'ಬ್ರಹ್ಮಾವರ', nameEn: 'Brahmavar', lat: 13.4333, lng: 74.7500, state: 'Karnataka' },
  { name: 'ಕಾರ್ಕಳ', nameEn: 'Karkala', lat: 13.2167, lng: 74.9833, state: 'Karnataka' },
  { name: 'ಮೂಡಬಿದಿರೆ', nameEn: 'Moodbidri', lat: 13.0667, lng: 74.9833, state: 'Karnataka' },
  { name: 'ಪುತ್ತೂರು', nameEn: 'Puttur', lat: 12.7597, lng: 75.2039, state: 'Karnataka' },
  { name: 'ಸುಳ್ಯ', nameEn: 'Sullia', lat: 12.5622, lng: 75.3883, state: 'Karnataka' },
  { name: 'ಮಡಿಕೇರಿ', nameEn: 'Madikeri', lat: 12.4244, lng: 75.7382, state: 'Karnataka' },
  { name: 'ವಿರಾಜಪೇಟೆ', nameEn: 'Virajpet', lat: 12.1967, lng: 75.8028, state: 'Karnataka' },
  { name: 'ಸೋಮವಾರಪೇಟೆ', nameEn: 'Somwarpet', lat: 12.6000, lng: 75.8500, state: 'Karnataka' },
  { name: 'ಬೆಂಗಳೂರು ಗ್ರಾಮಾಂತರ', nameEn: 'Bengaluru Rural', lat: 13.2257, lng: 77.5750, state: 'Karnataka' },
  { name: 'ದೇವನಹಳ್ಳಿ', nameEn: 'Devanahalli', lat: 13.2466, lng: 77.7176, state: 'Karnataka' },
  { name: 'ನೆಲಮಂಗಲ', nameEn: 'Nelamangala', lat: 13.0978, lng: 77.3925, state: 'Karnataka' },
  { name: 'ಹೊಸಕೋಟೆ', nameEn: 'Hoskote', lat: 13.0700, lng: 77.7982, state: 'Karnataka' },
  { name: 'ಚನ್ನಪಟ್ಟಣ', nameEn: 'Channapatna', lat: 12.6518, lng: 77.2067, state: 'Karnataka' },
  { name: 'ರಾಮನಗರ', nameEn: 'Ramanagara', lat: 12.7177, lng: 77.2823, state: 'Karnataka' },
  { name: 'ಕನಕಪುರ', nameEn: 'Kanakapura', lat: 12.5504, lng: 77.4192, state: 'Karnataka' },
  { name: 'ಮಾಗಡಿ', nameEn: 'Magadi', lat: 12.9500, lng: 77.2167, state: 'Karnataka' },
  { name: 'ಚಿಕ್ಕಬಳ್ಳಾಪುರ', nameEn: 'Chikballapur', lat: 13.4347, lng: 77.7280, state: 'Karnataka' },
  { name: 'ಶಿಡ್ಲಘಟ್ಟ', nameEn: 'Sidlaghatta', lat: 13.3833, lng: 77.8667, state: 'Karnataka' },
  { name: 'ಗೌರಿಬಿದನೂರು', nameEn: 'Gauribidanur', lat: 13.6167, lng: 77.5167, state: 'Karnataka' },
  { name: 'ಶ್ರೀನಿವಾಸಪುರ', nameEn: 'Srinivaspur', lat: 13.3333, lng: 78.2167, state: 'Karnataka' },
  { name: 'ಮುಳಬಾಗಲು', nameEn: 'Mulbagal', lat: 13.1667, lng: 78.3833, state: 'Karnataka' },
  { name: 'ಬಂಗಾರಪೇಟೆ', nameEn: 'Bangarpet', lat: 12.9833, lng: 78.1833, state: 'Karnataka' },
  { name: 'ಮಾಲೂರು', nameEn: 'Malur', lat: 13.0000, lng: 77.9333, state: 'Karnataka' },
  { name: 'ಕೆ.ಜಿ.ಎಫ್', nameEn: 'KGF', lat: 12.9525, lng: 78.2728, state: 'Karnataka' },
  { name: 'ಚಿಂತಾಮಣಿ', nameEn: 'Chintamani', lat: 13.4000, lng: 78.0500, state: 'Karnataka' },
  { name: 'ಸಿರ', nameEn: 'Sira', lat: 13.7333, lng: 76.9000, state: 'Karnataka' },
  { name: 'ಪಾವಗಡ', nameEn: 'Pavagada', lat: 14.1000, lng: 77.2833, state: 'Karnataka' },
  { name: 'ಮಧುಗಿರಿ', nameEn: 'Madhugiri', lat: 13.6667, lng: 77.2167, state: 'Karnataka' },
  { name: 'ಕೊರಟಗೆರೆ', nameEn: 'Koratagere', lat: 13.5167, lng: 77.2333, state: 'Karnataka' },
  { name: 'ಗುಬ್ಬಿ', nameEn: 'Gubbi', lat: 13.3167, lng: 76.9333, state: 'Karnataka' },
  { name: 'ತಿಪಟೂರು', nameEn: 'Tiptur', lat: 13.2500, lng: 76.4667, state: 'Karnataka' },
  { name: 'ಅರಸೀಕೆರೆ', nameEn: 'Arsikere', lat: 13.3167, lng: 76.2667, state: 'Karnataka' },
  { name: 'ಚನ್ನರಾಯಪಟ್ಟಣ', nameEn: 'Channarayapatna', lat: 12.9047, lng: 76.3908, state: 'Karnataka' },
  { name: 'ಹೊಳೆನರಸೀಪುರ', nameEn: 'Holenarasipura', lat: 12.7833, lng: 76.2500, state: 'Karnataka' },
  { name: 'ಸಾಲೂರು', nameEn: 'Sakleshpur', lat: 12.9417, lng: 75.7833, state: 'Karnataka' },
  { name: 'ಬೇಲೂರು', nameEn: 'Belur', lat: 13.1608, lng: 75.8650, state: 'Karnataka' },
  { name: 'ಹಳೇಬೀಡು', nameEn: 'Halebidu', lat: 13.2108, lng: 75.9922, state: 'Karnataka' },
  { name: 'ಶ್ರವಣಬೆಳಗೊಳ', nameEn: 'Shravanabelagola', lat: 12.8667, lng: 76.4833, state: 'Karnataka' },
  { name: 'ನಂಜನಗೂಡು', nameEn: 'Nanjangud', lat: 12.1167, lng: 76.6833, state: 'Karnataka' },
  { name: 'ಗುಂಡ್ಲುಪೇಟೆ', nameEn: 'Gundlupet', lat: 11.8000, lng: 76.6833, state: 'Karnataka' },
  { name: 'ಹೆಗ್ಗಡದೇವನಕೋಟೆ', nameEn: 'HD Kote', lat: 12.0833, lng: 76.3333, state: 'Karnataka' },
  { name: 'ಕೊಳ್ಳೆಗಾಲ', nameEn: 'Kollegal', lat: 12.1500, lng: 77.1167, state: 'Karnataka' },
  { name: 'ಯಳಂದೂರು', nameEn: 'Yelandur', lat: 12.0500, lng: 77.0333, state: 'Karnataka' },
  { name: 'ಬನ್ನೂರು', nameEn: 'Bannur', lat: 12.3333, lng: 76.8667, state: 'Karnataka' },
  { name: 'ತಿ.ನರಸೀಪುರ', nameEn: 'T Narasipura', lat: 12.2167, lng: 76.9000, state: 'Karnataka' },
  { name: 'ಹುಣಸೂರು', nameEn: 'Hunsur', lat: 12.3000, lng: 76.2833, state: 'Karnataka' },
  { name: 'ಕೃಷ್ಣರಾಜನಗರ', nameEn: 'K R Nagar', lat: 12.4333, lng: 76.3833, state: 'Karnataka' },
  { name: 'ಪಿರಿಯಾಪಟ್ಟಣ', nameEn: 'Piriyapatna', lat: 12.3333, lng: 76.1000, state: 'Karnataka' },
  { name: 'ಸರಗೂರು', nameEn: 'Saragur', lat: 11.9833, lng: 76.4000, state: 'Karnataka' },
];
...
export const RAJASTHAN_CITIES = [
  ...
  { name: 'नागौर', nameEn: 'Nagaur', lat: 27.2000, lng: 73.7333, state: 'Rajasthan' },
  { name: 'बारां', nameEn: 'Baran', lat: 25.1000, lng: 76.5167, state: 'Rajasthan' },
  { name: 'बूंदी', nameEn: 'Bundi', lat: 25.4386, lng: 75.6378, state: 'Rajasthan' },
  { name: 'चित्तौड़गढ़', nameEn: 'Chittorgarh', lat: 24.8887, lng: 74.6269, state: 'Rajasthan' },
  { name: 'राजसमंद', nameEn: 'Rajsamand', lat: 25.0730, lng: 73.8811, state: 'Rajasthan' },
  { name: 'डूंगरपुर', nameEn: 'Dungarpur', lat: 23.8417, lng: 73.7147, state: 'Rajasthan' },
  { name: 'बांसवाड़ा', nameEn: 'Banswara', lat: 23.5500, lng: 74.4333, state: 'Rajasthan' },
  { name: 'प्रतापगढ़', nameEn: 'Pratapgarh Rajasthan', lat: 24.0300, lng: 74.7800, state: 'Rajasthan' },
  { name: 'भीलवाड़ा', nameEn: 'Bhilwara', lat: 25.3479, lng: 74.6347, state: 'Rajasthan' },
  { name: 'टोंक', nameEn: 'Tonk', lat: 26.1667, lng: 75.7833, state: 'Rajasthan' },
  { name: 'सवाई माधोपुर', nameEn: 'Sawai Madhopur', lat: 26.0200, lng: 76.3500, state: 'Rajasthan' },
  { name: 'करौली', nameEn: 'Karauli', lat: 26.4983, lng: 77.0191, state: 'Rajasthan' },
  { name: 'धौलपुर', nameEn: 'Dholpur', lat: 26.7017, lng: 77.8867, state: 'Rajasthan' },
  { name: 'बीकानेर', nameEn: 'Bikaner', lat: 28.0229, lng: 73.3119, state: 'Rajasthan' },
  { name: 'हनुमानगढ़', nameEn: 'Hanumangarh', lat: 29.5833, lng: 74.3167, state: 'Rajasthan' },
  { name: 'जालौर', nameEn: 'Jalore', lat: 25.3500, lng: 72.6167, state: 'Rajasthan' },
  { name: 'सिरोही', nameEn: 'Sirohi', lat: 24.8833, lng: 72.8500, state: 'Rajasthan' },
  { name: 'बाड़मेर', nameEn: 'Barmer', lat: 25.7500, lng: 71.3833, state: 'Rajasthan' },
  { name: 'दौसा', nameEn: 'Dausa', lat: 26.8833, lng: 76.3333, state: 'Rajasthan' },
  { name: 'जयपुर ग्रामीण', nameEn: 'Jaipur Rural', lat: 26.8000, lng: 75.6500, state: 'Rajasthan' },
  { name: 'बीकानेर ग्रामीण', nameEn: 'Bikaner Rural', lat: 27.9500, lng: 73.2167, state: 'Rajasthan' },
  { name: 'नाथद्वारा', nameEn: 'Nathdwara', lat: 24.9308, lng: 73.8225, state: 'Rajasthan' },
  { name: 'राणकपुर', nameEn: 'Ranakpur', lat: 25.1181, lng: 73.4711, state: 'Rajasthan' },
  { name: 'कुम्भलगढ़', nameEn: 'Kumbhalgarh', lat: 25.1519, lng: 73.5869, state: 'Rajasthan' },
  { name: 'केशरियाजी', nameEn: 'Kesariyaji', lat: 24.7889, lng: 73.9656, state: 'Rajasthan' },
  { name: 'रणथंभौर', nameEn: 'Ranthambore', lat: 26.0173, lng: 76.5026, state: 'Rajasthan' },
  { name: 'फतेहपुर सीकरी', nameEn: 'Fatehpur Sikri', lat: 27.0939, lng: 77.6600, state: 'Rajasthan' },
  { name: 'भरतपुर पक्षी', nameEn: 'Keoladeo Ghana', lat: 27.1591, lng: 77.5221, state: 'Rajasthan' },
];
...
export const UTTAR_PRADESH_CITIES = [
  ...
  // More UP Towns
  { name: 'फ़िरोज़ाबाद', nameEn: 'Firozabad', lat: 27.1591, lng: 78.3957, state: 'Uttar Pradesh' },
  { name: 'रामपुर', nameEn: 'Rampur', lat: 28.8089, lng: 79.0250, state: 'Uttar Pradesh' },
  { name: 'शाहजहाँपुर', nameEn: 'Shahjahanpur', lat: 27.8818, lng: 79.9110, state: 'Uttar Pradesh' },
  { name: 'मुज़फ़्फ़रनगर', nameEn: 'Muzaffarnagar', lat: 29.4727, lng: 77.7085, state: 'Uttar Pradesh' },
  { name: 'बुलंदशहर', nameEn: 'Bulandshahr', lat: 28.4070, lng: 77.8498, state: 'Uttar Pradesh' },
  { name: 'हापुड़', nameEn: 'Hapur', lat: 28.7305, lng: 77.7610, state: 'Uttar Pradesh' },
  { name: 'इटावा', nameEn: 'Etawah', lat: 26.7885, lng: 79.0208, state: 'Uttar Pradesh' },
  { name: 'मैनपुरी', nameEn: 'Mainpuri', lat: 27.2329, lng: 79.0206, state: 'Uttar Pradesh' },
  { name: 'फ़तेहपुर', nameEn: 'Fatehpur', lat: 25.9277, lng: 80.8138, state: 'Uttar Pradesh' },
  { name: 'उन्नाव', nameEn: 'Unnao', lat: 26.5465, lng: 80.4879, state: 'Uttar Pradesh' },
  { name: 'रायबरेली', nameEn: 'Rae Bareli', lat: 26.2345, lng: 81.2308, state: 'Uttar Pradesh' },
  { name: 'सुलतानपुर', nameEn: 'Sultanpur', lat: 26.2648, lng: 82.0727, state: 'Uttar Pradesh' },
  { name: 'बांदा', nameEn: 'Banda', lat: 25.4752, lng: 80.3358, state: 'Uttar Pradesh' },
  { name: 'हमीरपुर', nameEn: 'Hamirpur', lat: 25.9514, lng: 80.1412, state: 'Uttar Pradesh' },
  { name: 'बाराबंकी', nameEn: 'Barabanki', lat: 26.9283, lng: 81.1848, state: 'Uttar Pradesh' },
  { name: 'फ़ैज़ाबाद', nameEn: 'Faizabad', lat: 26.7736, lng: 82.1453, state: 'Uttar Pradesh' },
  { name: 'देवरिया', nameEn: 'Deoria', lat: 26.5024, lng: 83.7791, state: 'Uttar Pradesh' },
  { name: 'कुशीनगर', nameEn: 'Kushinagar', lat: 26.7414, lng: 83.8864, state: 'Uttar Pradesh' },
  { name: 'बस्ती', nameEn: 'Basti', lat: 26.8006, lng: 82.7455, state: 'Uttar Pradesh' },
  { name: 'आजमगढ़', nameEn: 'Azamgarh', lat: 26.0739, lng: 83.1862, state: 'Uttar Pradesh' },
  { name: 'मऊ', nameEn: 'Mau', lat: 25.9416, lng: 83.5616, state: 'Uttar Pradesh' },
  { name: 'बलिया', nameEn: 'Ballia', lat: 25.7614, lng: 84.1486, state: 'Uttar Pradesh' },
  { name: 'गाज़ीपुर', nameEn: 'Ghazipur', lat: 25.5878, lng: 83.5780, state: 'Uttar Pradesh' },
  { name: 'जौनपुर', nameEn: 'Jaunpur', lat: 25.7464, lng: 82.6836, state: 'Uttar Pradesh' },
  { name: 'मिर्ज़ापुर', nameEn: 'Mirzapur', lat: 25.1337, lng: 82.5644, state: 'Uttar Pradesh' },
  { name: 'सोनभद्र', nameEn: 'Sonbhadra', lat: 24.6921, lng: 83.0678, state: 'Uttar Pradesh' },
  { name: 'चंदौली', nameEn: 'Chandauli', lat: 25.2628, lng: 83.2635, state: 'Uttar Pradesh' },
  { name: 'संत रविदास नगर', nameEn: 'Sant Ravidas Nagar', lat: 25.3889, lng: 82.9861, state: 'Uttar Pradesh' },
  { name: 'प्रतापगढ़', nameEn: 'Pratapgarh', lat: 25.8939, lng: 81.9408, state: 'Uttar Pradesh' },
  { name: 'अंबेडकर नगर', nameEn: 'Ambedkar Nagar', lat: 26.4473, lng: 82.7361, state: 'Uttar Pradesh' },
  { name: 'लखीमपुर खीरी', nameEn: 'Lakhimpur Kheri', lat: 27.9470, lng: 80.7799, state: 'Uttar Pradesh' },
  { name: 'सीतापुर', nameEn: 'Sitapur', lat: 27.5706, lng: 80.6829, state: 'Uttar Pradesh' },
  { name: 'हरदोई', nameEn: 'Hardoi', lat: 27.3956, lng: 80.1312, state: 'Uttar Pradesh' },
  { name: 'पीलीभीत', nameEn: 'Pilibhit', lat: 28.6316, lng: 79.8030, state: 'Uttar Pradesh' },
  { name: 'बिजनौर', nameEn: 'Bijnor', lat: 29.3724, lng: 78.1355, state: 'Uttar Pradesh' },
  { name: 'अमरोहा', nameEn: 'Amroha', lat: 28.9044, lng: 78.4653, state: 'Uttar Pradesh' },
  { name: 'संभल', nameEn: 'Sambhal', lat: 28.5858, lng: 78.5549, state: 'Uttar Pradesh' },
  { name: 'बदायूं', nameEn: 'Badaun', lat: 28.0334, lng: 79.1204, state: 'Uttar Pradesh' },
  { name: 'एटा', nameEn: 'Etah', lat: 27.6339, lng: 78.6608, state: 'Uttar Pradesh' },
  { name: 'कासगंज', nameEn: 'Kasganj', lat: 27.8042, lng: 78.6469, state: 'Uttar Pradesh' },
  { name: 'हाथरस', nameEn: 'Hathras', lat: 27.5936, lng: 78.0519, state: 'Uttar Pradesh' },
  { name: 'औरैया', nameEn: 'Auraiya', lat: 26.4655, lng: 79.5186, state: 'Uttar Pradesh' },
  { name: 'कन्नौज', nameEn: 'Kannauj', lat: 27.0556, lng: 79.9139, state: 'Uttar Pradesh' },
  { name: 'फ़र्रूख़ाबाद', nameEn: 'Farrukhabad', lat: 27.3907, lng: 79.5799, state: 'Uttar Pradesh' },
  { name: 'शामली', nameEn: 'Shamli', lat: 29.4519, lng: 77.3064, state: 'Uttar Pradesh' },
  { name: 'बागपत', nameEn: 'Baghpat', lat: 28.9452, lng: 77.2187, state: 'Uttar Pradesh' },
  { name: 'ललितपुर', nameEn: 'Lalitpur', lat: 24.6877, lng: 78.4161, state: 'Uttar Pradesh' },
  { name: 'महोबा', nameEn: 'Mahoba', lat: 25.2918, lng: 79.8717, state: 'Uttar Pradesh' },
  { name: 'चित्रकूट', nameEn: 'Chitrakoot', lat: 25.2050, lng: 80.9005, state: 'Uttar Pradesh' },
];
...
export const MADHYA_PRADESH_CITIES = [
  ...
  // More MP Towns
  { name: 'छिंदवाड़ा', nameEn: 'Chhindwara', lat: 22.0574, lng: 78.9382, state: 'Madhya Pradesh' },
  { name: 'बुरहानपुर', nameEn: 'Burhanpur', lat: 21.3104, lng: 76.2294, state: 'Madhya Pradesh' },
  { name: 'मुरैना', nameEn: 'Morena', lat: 26.5000, lng: 77.9833, state: 'Madhya Pradesh' },
  { name: 'भिण्ड', nameEn: 'Bhind', lat: 26.5676, lng: 78.7799, state: 'Madhya Pradesh' },
  { name: 'शिवपुरी', nameEn: 'Shivpuri', lat: 25.4237, lng: 77.6613, state: 'Madhya Pradesh' },
  { name: 'विदिशा', nameEn: 'Vidisha', lat: 23.5251, lng: 77.8081, state: 'Madhya Pradesh' },
  { name: 'गुना', nameEn: 'Guna', lat: 24.6584, lng: 77.3124, state: 'Madhya Pradesh' },
  { name: 'दमोह', nameEn: 'Damoh', lat: 23.8360, lng: 79.4419, state: 'Madhya Pradesh' },
  { name: 'पन्ना', nameEn: 'Panna', lat: 24.7180, lng: 80.1853, state: 'Madhya Pradesh' },
  { name: 'छतरपुर', nameEn: 'Chhatarpur', lat: 24.9154, lng: 79.5889, state: 'Madhya Pradesh' },
  { name: 'टीकमगढ़', nameEn: 'Tikamgarh', lat: 24.7439, lng: 78.8317, state: 'Madhya Pradesh' },
  { name: 'मंडला', nameEn: 'Mandla', lat: 22.5980, lng: 80.3718, state: 'Madhya Pradesh' },
  { name: 'बालाघाट', nameEn: 'Balaghat', lat: 21.8305, lng: 80.1853, state: 'Madhya Pradesh' },
  { name: 'सिवनी', nameEn: 'Seoni', lat: 22.0854, lng: 79.5368, state: 'Madhya Pradesh' },
  { name: 'नरसिंहपुर', nameEn: 'Narsinghpur', lat: 22.9475, lng: 79.1939, state: 'Madhya Pradesh' },
  { name: 'होशंगाबाद', nameEn: 'Hoshangabad', lat: 22.7473, lng: 77.7309, state: 'Madhya Pradesh' },
  { name: 'बेतूल', nameEn: 'Betul', lat: 21.9045, lng: 77.9008, state: 'Madhya Pradesh' },
  { name: 'खंडवा', nameEn: 'Khandwa', lat: 21.8232, lng: 76.3510, state: 'Madhya Pradesh' },
  { name: 'मंदसौर', nameEn: 'Mandsaur', lat: 24.0666, lng: 75.0713, state: 'Madhya Pradesh' },
  { name: 'नीमच', nameEn: 'Neemuch', lat: 24.4744, lng: 74.8671, state: 'Madhya Pradesh' },
  { name: 'शाजापुर', nameEn: 'Shajapur', lat: 23.4272, lng: 76.2698, state: 'Madhya Pradesh' },
  { name: 'आगर मालवा', nameEn: 'Agar Malwa', lat: 23.7178, lng: 76.0165, state: 'Madhya Pradesh' },
  { name: 'धार', nameEn: 'Dhar', lat: 22.6014, lng: 75.3025, state: 'Madhya Pradesh' },
  { name: 'झाबुआ', nameEn: 'Jhabua', lat: 22.7717, lng: 74.5956, state: 'Madhya Pradesh' },
  { name: 'बड़वानी', nameEn: 'Barwani', lat: 22.0344, lng: 74.9023, state: 'Madhya Pradesh' },
  { name: 'खरगोन', nameEn: 'Khargone', lat: 21.8224, lng: 75.6146, state: 'Madhya Pradesh' },
  { name: 'सीधी', nameEn: 'Sidhi', lat: 24.4143, lng: 81.8818, state: 'Madhya Pradesh' },
  { name: 'सिंगरौली', nameEn: 'Singrauli', lat: 24.1993, lng: 82.6655, state: 'Madhya Pradesh' },
  { name: 'शहडोल', nameEn: 'Shahdol', lat: 23.3015, lng: 81.3575, state: 'Madhya Pradesh' },
  { name: 'अनूपपुर', nameEn: 'Anuppur', lat: 23.1043, lng: 81.6948, state: 'Madhya Pradesh' },
  { name: 'डिंडोरी', nameEn: 'Dindori', lat: 22.9470, lng: 81.0761, state: 'Madhya Pradesh' },
  { name: 'उमरिया', nameEn: 'Umaria', lat: 23.5225, lng: 80.8364, state: 'Madhya Pradesh' },
  { name: 'कटनी', nameEn: 'Katni', lat: 23.8346, lng: 80.3948, state: 'Madhya Pradesh' },
  { name: 'महाराजपुर', nameEn: 'Maharajpur', lat: 26.4887, lng: 78.9389, state: 'Madhya Pradesh' },
  { name: 'दतिया', nameEn: 'Datia', lat: 25.6661, lng: 78.4598, state: 'Madhya Pradesh' },
  { name: 'अशोकनगर', nameEn: 'Ashoknagar', lat: 24.5817, lng: 77.7265, state: 'Madhya Pradesh' },
  { name: 'राजगढ़', nameEn: 'Rajgarh', lat: 24.0424, lng: 76.7275, state: 'Madhya Pradesh' },
  { name: 'सीहोर', nameEn: 'Sehore', lat: 23.2024, lng: 77.0861, state: 'Madhya Pradesh' },
  { name: 'हरदा', nameEn: 'Harda', lat: 22.3423, lng: 77.0963, state: 'Madhya Pradesh' },
];
...
export const BIHAR_CITIES = [
  ...
  // More Bihar Towns
  { name: 'सहरसा', nameEn: 'Saharsa', lat: 25.8779, lng: 86.5998, state: 'Bihar' },
  { name: 'मधुबनी', nameEn: 'Madhubani', lat: 26.3536, lng: 86.0719, state: 'Bihar' },
  { name: 'सीतामढ़ी', nameEn: 'Sitamarhi', lat: 26.5907, lng: 85.4910, state: 'Bihar' },
  { name: 'मोतिहारी', nameEn: 'Motihari', lat: 26.6617, lng: 84.9153, state: 'Bihar' },
  { name: 'छपरा', nameEn: 'Chhapra', lat: 25.7804, lng: 84.7499, state: 'Bihar' },
  { name: 'सिवान', nameEn: 'Siwan', lat: 26.2180, lng: 84.3587, state: 'Bihar' },
  { name: 'गोपालगंज', nameEn: 'Gopalganj', lat: 26.4670, lng: 84.4336, state: 'Bihar' },
  { name: 'बेतिया', nameEn: 'Bettiah', lat: 26.8017, lng: 84.5030, state: 'Bihar' },
  { name: 'हाजीपुर', nameEn: 'Hajipur', lat: 25.6837, lng: 85.2168, state: 'Bihar' },
  { name: 'मुंगेर', nameEn: 'Munger', lat: 25.3708, lng: 86.4716, state: 'Bihar' },
  { name: 'समस्तीपुर', nameEn: 'Samastipur', lat: 25.8550, lng: 85.7814, state: 'Bihar' },
  { name: 'खगड़िया', nameEn: 'Khagaria', lat: 25.5022, lng: 86.4712, state: 'Bihar' },
  { name: 'जहानाबाद', nameEn: 'Jehanabad', lat: 25.2124, lng: 84.9889, state: 'Bihar' },
  { name: 'नवादा', nameEn: 'Nawada', lat: 24.8846, lng: 85.5340, state: 'Bihar' },
  { name: 'औरंगाबाद', nameEn: 'Aurangabad Bihar', lat: 24.7516, lng: 84.3740, state: 'Bihar' },
  { name: 'बक्सर', nameEn: 'Buxar', lat: 25.5677, lng: 83.9780, state: 'Bihar' },
  { name: 'रोहतास', nameEn: 'Rohtas', lat: 24.9692, lng: 84.0078, state: 'Bihar' },
  { name: 'कैमूर', nameEn: 'Kaimur', lat: 25.0523, lng: 83.5841, state: 'Bihar' },
  { name: 'लखीसराय', nameEn: 'Lakhisarai', lat: 25.1632, lng: 86.0978, state: 'Bihar' },
  { name: 'शेखपुरा', nameEn: 'Sheikhpura', lat: 25.1399, lng: 85.8510, state: 'Bihar' },
  { name: 'जमुई', nameEn: 'Jamui', lat: 24.9252, lng: 86.2252, state: 'Bihar' },
  { name: 'बांका', nameEn: 'Banka', lat: 24.8887, lng: 86.9205, state: 'Bihar' },
  { name: 'किशनगंज', nameEn: 'Kishanganj', lat: 26.0903, lng: 87.9390, state: 'Bihar' },
  { name: 'अररिया', nameEn: 'Araria', lat: 26.1569, lng: 87.4601, state: 'Bihar' },
  { name: 'सुपौल', nameEn: 'Supaul', lat: 26.1232, lng: 86.6044, state: 'Bihar' },
  { name: 'मधेपुरा', nameEn: 'Madhepura', lat: 25.9190, lng: 86.7916, state: 'Bihar' },
  { name: 'वैशाली', nameEn: 'Vaishali', lat: 25.6858, lng: 85.4164, state: 'Bihar' },
];
...
export const WEST_BENGAL_CITIES = [
  ...
  { name: 'বহরমপুর', nameEn: 'Berhampore', lat: 24.1010, lng: 88.2512, state: 'West Bengal' },
  { name: 'রানাঘাট', nameEn: 'Ranaghat', lat: 23.1757, lng: 88.5666, state: 'West Bengal' },
  { name: 'বারাসাত', nameEn: 'Barasat', lat: 22.7233, lng: 88.4803, state: 'West Bengal' },
  { name: 'ব্যারাকপুর', nameEn: 'Barrackpore', lat: 22.7567, lng: 88.3622, state: 'West Bengal' },
  { name: 'নবদ্বীপ', nameEn: 'Nabadwip', lat: 23.4073, lng: 88.3678, state: 'West Bengal' },
  { name: 'কৃষ্ণনগর', nameEn: 'Krishnanagar', lat: 23.4014, lng: 88.4900, state: 'West Bengal' },
  { name: 'চন্দননগর', nameEn: 'Chandannagar', lat: 22.8711, lng: 88.3653, state: 'West Bengal' },
  { name: 'শ্রীরামপুর', nameEn: 'Serampore', lat: 22.7542, lng: 88.3436, state: 'West Bengal' },
  { name: 'কল্যাণী', nameEn: 'Kalyani', lat: 22.9752, lng: 88.4344, state: 'West Bengal' },
  { name: 'বাঁকুড়া', nameEn: 'Bankura', lat: 23.2324, lng: 87.0666, state: 'West Bengal' },
  { name: 'পুরুলিয়া', nameEn: 'Purulia', lat: 23.3333, lng: 86.3500, state: 'West Bengal' },
  { name: 'মেদিনীপুর', nameEn: 'Midnapore', lat: 22.4251, lng: 87.3200, state: 'West Bengal' },
  { name: 'হলদিয়া', nameEn: 'Haldia', lat: 22.0667, lng: 88.0667, state: 'West Bengal' },
  { name: 'দমদম', nameEn: 'Dum Dum', lat: 22.6242, lng: 88.4295, state: 'West Bengal' },
  { name: 'জলপাইগুড়ি', nameEn: 'Jalpaiguri', lat: 26.5167, lng: 88.7333, state: 'West Bengal' },
  { name: 'আলিপুরদুয়ার', nameEn: 'Alipurduar', lat: 26.4881, lng: 89.5271, state: 'West Bengal' },
  { name: 'রায়গঞ্জ', nameEn: 'Raiganj', lat: 25.6184, lng: 88.1211, state: 'West Bengal' },
  { name: 'বালুরঘাট', nameEn: 'Balurghat', lat: 25.2209, lng: 88.7548, state: 'West Bengal' },
  { name: 'ইসলামপুর', nameEn: 'Islampur', lat: 26.2669, lng: 88.2039, state: 'West Bengal' },
  { name: 'বীরভূম', nameEn: 'Birbhum', lat: 23.8347, lng: 87.5831, state: 'West Bengal' },
  { name: 'বোলপুর', nameEn: 'Bolpur', lat: 23.6679, lng: 87.7123, state: 'West Bengal' },
  { name: 'কাটোয়া', nameEn: 'Katwa', lat: 23.6458, lng: 88.1307, state: 'West Bengal' },
  { name: 'তমলুক', nameEn: 'Tamluk', lat: 22.2990, lng: 87.9180, state: 'West Bengal' },
  { name: 'ঝাড়গ্রাম', nameEn: 'Jhargram', lat: 22.4521, lng: 86.9923, state: 'West Bengal' },
  { name: 'দিঘা', nameEn: 'Digha', lat: 21.6256, lng: 87.5047, state: 'West Bengal' },
  { name: 'বকখালি', nameEn: 'Bakkhali', lat: 21.5608, lng: 88.2520, state: 'West Bengal' },
  { name: 'সাগরদ্বীপ', nameEn: 'Sagar Island', lat: 21.6511, lng: 88.0656, state: 'West Bengal' },
];
