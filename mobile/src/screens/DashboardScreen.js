...
const styles = StyleSheet.create({
  ...
  dashaLabel: { fontSize: 11, color: '#0f172a', fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.8 },
  dashaValue: { fontSize: 16, fontWeight: '900', color: '#0f172a', marginTop: 8, letterSpacing: 0 },
  ...
  parigaramTitle: { fontSize: 18, fontWeight: '800', color: '#0f172a', letterSpacing: 0.3, fontFamily: Platform.OS === 'ios' ? 'Georgia' : 'serif' },
  ...
  parigaramPlanetName: { fontSize: 13, fontWeight: '800', color: '#0f172a', letterSpacing: 0.2 },
  ...
  parigaramTipText: { fontSize: 10, color: '#0f172a', fontWeight: '700' },
