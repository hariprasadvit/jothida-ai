...
const styles = StyleSheet.create({
  ...
  parigaramTitle: { fontSize: 18, fontWeight: '600', color: '#6b5644', letterSpacing: 0.3, fontFamily: Platform.OS === 'ios' ? 'Georgia' : 'serif' },
  parigaramSubtitle: { fontSize: 12, color: '#8b6f47', marginTop: 4, fontWeight: '600' },
  ...
  parigaramPlanetName: { fontSize: 13, fontWeight: '700', color: '#6b5644', letterSpacing: 0.2 },
