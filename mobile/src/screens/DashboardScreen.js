...
const styles = StyleSheet.create({
  ...
  lifeAreaIconBg: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center', backgroundColor: '#e8ecf3', shadowColor: '#ffffff', shadowOffset: { width: -3, height: -3 }, shadowOpacity: 1, shadowRadius: 6 },
  lifeAreaBadge: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 14, backgroundColor: '#e8ecf3', shadowColor: '#a3b9d9', shadowOffset: { width: 2, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4 },
  lifeAreaBadgeText: { fontSize: 10, fontWeight: '800', letterSpacing: 0.5 },
  lifeAreaName: { fontSize: 14, color: '#5a6c8f', fontWeight: '800', marginBottom: 10, letterSpacing: 0.4 },
  lifeAreaScoreRow: { flexDirection: 'row', alignItems: 'baseline' },
  lifeAreaScore: { fontSize: 34, fontWeight: '900', letterSpacing: -1 },
  ...
  monthCard: { width: 90, backgroundColor: '#e8ecf3', borderRadius: 20, padding: 14, marginHorizontal: 6, alignItems: 'center', shadowColor: '#a3b9d9', shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8 },
  monthName: { fontSize: 11, color: '#5a6c8f', fontWeight: '800', marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1 },
  monthScoreBadge: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 14, marginBottom: 10, backgroundColor: '#e8ecf3', shadowColor: '#ffffff', shadowOffset: { width: -2, height: -2 }, shadowOpacity: 1, shadowRadius: 4 },
  monthScore: { fontSize: 16, fontWeight: '900' },
  monthBarContainer: { width: '100%', height: 6, backgroundColor: '#dfe7f5', borderRadius: 3 },
  ...
  yearCard: { borderRadius: 24, overflow: 'hidden', backgroundColor: '#e8ecf3', shadowColor: '#a3b9d9', shadowOffset: { width: 6, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12 },
  yearCardGradient: { flexDirection: 'row', alignItems: 'center', padding: 20, gap: 16, backgroundColor: '#e8ecf3' },
  yearIconBg: { width: 52, height: 52, borderRadius: 26, justifyContent: 'center', alignItems: 'center', backgroundColor: '#e8ecf3', shadowColor: '#ffffff', shadowOffset: { width: -3, height: -3 }, shadowOpacity: 1, shadowRadius: 6 },
  yearInfo: { flex: 1 },
  yearName: { fontSize: 20, fontWeight: '900', color: '#5a6c8f', letterSpacing: 0.8 },
  yearLabel: { fontSize: 13, color: '#7a8ba8', marginTop: 5, fontWeight: '700' },
  yearScoreContainer: { alignItems: 'flex-end', marginRight: 10 },
  yearScore: { fontSize: 26, fontWeight: '900', letterSpacing: -1, color: '#6b7fa0' },
  ...
  dashaCard: { backgroundColor: '#e8ecf3', shadowColor: '#a3b9d9', shadowOffset: { width: 6, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12 },
  dashaGrid: { flexDirection: 'row', gap: 16 },
  dashaItem: { flex: 1, backgroundColor: '#e8ecf3', borderRadius: 18, padding: 16, shadowColor: '#a3b9d9', shadowOffset: { width: 3, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6 },
  dashaLabel: { fontSize: 11, color: '#7a8ba8', fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1 },
  dashaValue: { fontSize: 16, fontWeight: '900', color: '#6b7fa0', marginTop: 8, letterSpacing: 0.4 },
  ...
  // Modal styles
  modalOverlay: { flex: 1, backgroundColor: 'rgba(90, 108, 143, 0.4)' },
  modalScrollView: { marginTop: 'auto', maxHeight: '88%' },
  modalContent: { backgroundColor: '#e8ecf3', borderTopLeftRadius: 32, borderTopRightRadius: 32, padding: 28, paddingBottom: 48, shadowColor: '#a3b9d9', shadowOffset: { width: 0, height: -8 }, shadowOpacity: 0.3, shadowRadius: 20 },
  modalHeader: { flexDirection: 'row', alignItems: 'center', gap: 16, marginBottom: 22 },
  modalIconBg: { width: 56, height: 56, borderRadius: 28, justifyContent: 'center', alignItems: 'center', backgroundColor: '#e8ecf3', shadowColor: '#ffffff', shadowOffset: { width: -4, height: -4 }, shadowOpacity: 1, shadowRadius: 8 },
  modalTitle: { flex: 1, fontSize: 21, fontWeight: '900', color: '#5a6c8f', letterSpacing: 0.8 },
  modalCloseBtn: { padding: 4 },
  modalScoreSection: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'center', marginBottom: 24 },
  modalScoreValue: { fontSize: 60, fontWeight: '900', letterSpacing: -2, color: '#6b7fa0' },
  modalScoreMax: { fontSize: 22, color: '#9babc7', marginLeft: 8, fontWeight: '800' },
  modalDivider: { height: 1, backgroundColor: '#c5d0e3', marginVertical: 22 },
  modalSectionTitle: { fontSize: 15, fontWeight: '900', color: '#5a6c8f', marginBottom: 16, textTransform: 'uppercase', letterSpacing: 1 },
  factorItem: { backgroundColor: '#e8ecf3', borderRadius: 18, padding: 16, marginBottom: 14, shadowColor: '#a3b9d9', shadowOffset: { width: 3, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6 },
  factorHeader: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  factorName: { flex: 1, fontSize: 14, fontWeight: '800', color: '#5a6c8f' },
  ...
  moonHeroInfo: { flex: 1 },
  moonHeroLabel: { fontSize: 11, color: '#7a8ba8', textTransform: 'uppercase', letterSpacing: 1.4, fontWeight: '900', marginBottom: 8 },
  moonHeroSign: { fontSize: 26, fontWeight: '900', color: '#5a6c8f', marginBottom: 5, letterSpacing: 0.5 },
  moonHeroPhase: { fontSize: 13, color: '#7a8ba8', fontWeight: '700' },
  moonEnergyCard: { paddingHorizontal: 18, paddingVertical: 14, borderRadius: 20, alignItems: 'center', backgroundColor: '#e8ecf3', shadowColor: '#a3b9d9', shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8 },
  ...
  // Countdown Timer
  countdownContainer: { alignItems: 'center', marginTop: 30, paddingTop: 30, borderTopWidth: 1, borderTopColor: '#c5d0e3', backgroundColor: '#e8ecf3', marginHorizontal: -26, paddingHorizontal: 26, paddingBottom: 26 },
  countdownLabel: { fontSize: 13, color: '#6b7fa0', marginBottom: 18, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.2 },
  countdownTimerRow: { flexDirection: 'row', alignItems: 'center', gap: 18 },
  countdownBox: { alignItems: 'center' },
  countdownBoxGradient: { width: 84, height: 84, borderRadius: 24, justifyContent: 'center', alignItems: 'center', backgroundColor: '#e8ecf3', shadowColor: '#a3b9d9', shadowOffset: { width: 6, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12 },
  countdownValue: { fontSize: 38, fontWeight: '900', color: '#6b7fa0', letterSpacing: -1 },
  countdownUnit: { fontSize: 11, color: '#7a8ba8', marginTop: 10, textTransform: 'uppercase', letterSpacing: 1.5, fontWeight: '800' },
  countdownSeparator: { fontSize: 38, fontWeight: '900', color: '#9babc7', marginBottom: 26 },
  nextSignRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 22, backgroundColor: '#e8ecf3', paddingHorizontal: 22, paddingVertical: 14, borderRadius: 26, shadowColor: '#a3b9d9', shadowOffset: { width: 5, height: 5 }, shadowOpacity: 0.3, shadowRadius: 10 },
  nextSignText: { fontSize: 15, fontWeight: '800', color: '#5a6c8f', flex: 1, letterSpacing: 0.4 },

  // Alert Message
  alertMessageBox: { flexDirection: 'row', alignItems: 'flex-start', gap: 16, backgroundColor: '#e8ecf3', padding: 20, paddingVertical: 22, marginTop: 26, marginHorizontal: -26, marginBottom: -26, borderRadius: 0, shadowColor: '#a3b9d9', shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.25, shadowRadius: 8 },
  alertMessageIconWrapper: { marginTop: 3, width: 26, height: 26, alignItems: 'center', justifyContent: 'center', backgroundColor: '#e8ecf3', borderRadius: 13, shadowColor: '#ffffff', shadowOffset: { width: -2, height: -2 }, shadowOpacity: 1, shadowRadius: 4 },
  alertMessageText: { flex: 1, fontSize: 14, color: '#5a6c8f', lineHeight: 24, fontWeight: '700', letterSpacing: 0.3 },
  ...
  planetCard: { alignItems: 'center', paddingHorizontal: 18, paddingVertical: 18, borderRadius: 24, marginRight: 16, minWidth: 100, backgroundColor: '#e8ecf3', shadowColor: '#a3b9d9', shadowOffset: { width: 5, height: 5 }, shadowOpacity: 0.3, shadowRadius: 10 },
  planetCardIconBg: { width: 52, height: 52, borderRadius: 26, justifyContent: 'center', alignItems: 'center', marginBottom: 12, backgroundColor: '#e8ecf3', shadowColor: '#ffffff', shadowOffset: { width: -3, height: -3 }, shadowOpacity: 1, shadowRadius: 6 },
  planetCardSymbol: { fontSize: 26 },
  planetCardName: { fontSize: 12, color: '#5a6c8f', fontWeight: '800', marginBottom: 10, textTransform: 'uppercase', letterSpacing: 0.8 },
