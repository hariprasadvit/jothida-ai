...
const styles = StyleSheet.create({
  ...
  dashaLabel: { fontSize: 11, color: '#8b6f47', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.8 },
  dashaValue: { fontSize: 16, fontWeight: '700', color: '#6b5644', marginTop: 8, letterSpacing: 0 },
